...
if ($send == 'true')
        {
        echo '<h1 class="success-head">Дякуємо!</h1><p class="success-p">Ми отримали ваше замовлення і передзвонимо найближчим часом.</p><button data-remodal-action="confirm" class="btn btn-quickorder" style="margin-top:20px;">Хорошо</button>';
        }
        else
        {
        echo '<center><p class="fail"><b>Помилка! Замовлення не відправлено!</b></p></center>';
        }
    } else {
